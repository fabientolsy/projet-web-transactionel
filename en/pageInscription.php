...
<body class="body">
    ...
    <input type="hidden" name="admin" value="0"/>
        ...
        <div class="form-group form-floating mb-3" id="password" >
            ...
            <label for="floatingInput4">Confirm the password</label>
        </div>

        <!-- ENTREPRISE -->
        <div class="form-group">            
            <label for="selectionEntreprise" class="form-label mt-4">Have you a companie ?</label>
            ...
            <div class="form-floating mb-3" id="entreprisename" style="display:none" >
                ...
                <label for="floatingInput2">Companie name</label>
            </div>
        </div>
        ...
        <div id="boutons">
            <button class="source-button btn btn-primary btn-xs" type="submit" tabindex="0" id="inscription"> Register</button>
            <button class="source-button btn btn-primary btn-xs" formaction="/" type="button" tabindex="0">Cancel</button>
        </div>
